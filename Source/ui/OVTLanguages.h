...
namespace ovt
{
    ...
    inline const std::unordered_map<std::string, const char*>& getTranslations (Language lang)
    {
        ...
        static const std::unordered_map<std::string, const char*> japanese = {
            ...
            { kMenuLoopPlayhead,   "ãƒ«ãƒ¼ãƒ—å†ç”Ÿ (å°ç¯€)" },
            { kMenuTooltipDelay,   "ãƒ„ãƒ¼ãƒ«ãƒãƒƒãƒ—è¡¨ç¤ºé…å»¶" },
            { kLabelTooltipDelaySlow,   "é…ã„" },
            { kLabelTooltipDelayNormal, "æ™®é€š" },
            { kLabelTooltipDelayFast,   "é€Ÿã„" },
            { kMenuTempo,          "ãƒ†ãƒ³ãƒ" },
            { kTooltipCurveOptions, "ã‚«ãƒ¼ãƒ–ã‚¨ãƒ‡ã‚£ã‚¿ã®ã‚ªãƒ—ã‚·ãƒ§ãƒ³" },
        ...
        static const std::unordered_map<std::string, const char*> chinese = {
            ...
            { kMenuLoopPlayhead,   "å¾ªçŽ¯æ’­æ”¾å¤´ï¼ˆå°èŠ‚ï¼‰" },
            { kMenuTooltipDelay,   "å·¥å…·æç¤ºå»¶è¿Ÿ" },
            { kLabelTooltipDelaySlow,   "æ…¢" },
            { kLabelTooltipDelayNormal, "æ™®é€š" },
            { kLabelTooltipDelayFast,   "å¿«" },
            { kMenuTempo,          "é€Ÿåº¦" },
            { kTooltipCurveOptions, "æ›²çº¿ç¼–è¾‘å™¨é€‰é¡¹" },
