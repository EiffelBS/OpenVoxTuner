...
namespace ovt
{
    ...
    inline juce::String tr (const char* key)
    {
        ...
        // Explicit UTF-8 conversion: without CharPointer_UTF8, juce::String(const char*)
        // only accepts ASCII and asserts (Debug) on characters > 127
        // (French, German, Spanish accents, and especially multi-byte Japanese).
