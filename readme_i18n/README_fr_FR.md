...
| **Supporter** | Patreon | Bientôt disponible | Discord privé + vote sur les fonctionnalités à venir |
| **Gold** | Patreon | Bientôt disponible | Tous les avantages Supporter + accès anticipé / builds bêta + nom dans les crédits |
